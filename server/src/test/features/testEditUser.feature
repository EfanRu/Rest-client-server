...
Функция: Редактирование пользователя
  ...
  Сценарий: Успешное редактирование пользователя
    ...
    И отсутствует запись с логином "Тест"
    То вносим следующие изменения в запись с логином "Петрович": имя "Тест", фамилия "Валид", логином "Тест", паролем "Валид", телефоном "0", ролью "admin"
    Тогда в UI и DB будет отображены изменения: имя "Тест", фамилия "Валид", логином "Тест", паролем "Валид", телефоном "0", ролью "admin"

  @fail
  Сценарий: Ошибочное редактирование пользователя из-за существующего в DB логина
    Если на сервере имеется запись с логином "Петрович"
    То вносим следующие изменения с существующим в DB логином в запись с логином "Петрович": имя "Тест", фамилия "Валид", логином "admin", паролем "Валид", телефоном "0", ролью "admin"
  ...
  Сценарий: Ошибочное редактирование пользователя из-за неверного номера телефона
    Если на сервере имеется запись с логином "Петрович"
    То вносим следующие изменения в запись с логином "Петрович": имя "Тест", фамилия "Валид", логином "Тест", паролем "Валид", телефоном "фывыфв", ролью "admin"
